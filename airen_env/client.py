...
class AIRENEnv(EnvClient[AIRENAction, AIRENObservation, AIRENState]):
    ...
    def _parse_result(self, payload: Dict[str, Any]) -> StepResult[AIRENObservation]:
        ...
        obs = AIRENObservation(
            ...
            exploration_bonus=obs_data.get("exploration_bonus"),
            recovery_bonus=obs_data.get("recovery_bonus"),
    ...
    def _parse_state(self, payload: Dict[str, Any]) -> AIRENState:
        return AIRENState(
            ...
            wrong_fixes_applied=payload.get("wrong_fixes_applied", 0),
            recovery_attempts=payload.get("recovery_attempts", 0),
            hypotheses_tested=payload.get("hypotheses_tested", 0),
        )
